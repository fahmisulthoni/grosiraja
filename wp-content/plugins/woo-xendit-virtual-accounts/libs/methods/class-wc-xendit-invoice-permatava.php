...
class WC_Xendit_PermataVA extends WC_Xendit_Invoice {
    public function __construct() {
        parent::__construct();

        $this->id           = 'xendit_permatava';
        ...
        $this->method_title = __( 'Xendit Permata VA', 'woocommerce-gateway-xendit' );
    ...
    public function init_form_fields() {
		$this->form_fields = require( WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-permatava-settings.php' );
    }
