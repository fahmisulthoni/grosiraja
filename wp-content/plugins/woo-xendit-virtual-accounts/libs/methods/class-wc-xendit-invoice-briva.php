...
class WC_Xendit_BRIVA extends WC_Xendit_Invoice {
    public function __construct() {
        parent::__construct();

        $this->id           = 'xendit_briva';
        ...
        $this->method_title = __( 'Xendit BRI VA', 'woocommerce-gateway-xendit' );
    ...
    public function init_form_fields() {
		$this->form_fields = require( WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-briva-settings.php' );
    }
