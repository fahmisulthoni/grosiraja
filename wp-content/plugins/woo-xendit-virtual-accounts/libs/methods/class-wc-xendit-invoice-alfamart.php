...
class WC_Xendit_Alfamart extends WC_Xendit_Invoice {
    const DEFAULT_MAXIMUM_AMOUNT = 5000000;
    
    public function __construct() {
        parent::__construct();

        $this->id           = 'xendit_alfamart';
        ...
        $this->default_title = 'Bayar di Alfamart Group';
